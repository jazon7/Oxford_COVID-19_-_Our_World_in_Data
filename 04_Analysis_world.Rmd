...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(
country_map(df_world_20211230,'2021-12-30',"stringency","World",'no'),
country_map(df_world_20211230,'2021-12-30',"total_deaths_per_million","World",'no'),
country_map(df_world_20211230,'2021-12-30',"sub_stringency","World",'no'), 
country_map(df_world_20211230,'2021-12-30',"sub_stringency_cubed","World",'no'), nrow = 2, ncol = 2) %>% 
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(
 country_scatter(df_world_20211230,"stringency",'no','no') + rremove("ylab"),
 country_scatter(df_world_20211230,"sub_stringency",'no','no') + rremove("ylab"),
 country_scatter(df_world_20211230,"lockdowns",'no','no') + rremove("ylab"), ncol = 1, common.legend = T, legend = c("right")) %>% 
  annotate_figure(map, top = text_grob(paste0("Covid deaths vs. restrictions ", "2021-12-30"), color = "black", 
          face = "bold", size = 16), 
                       left = text_grob("Total Deaths per Million", rot = 90, vjust = 1))

ggarrange(
country_scatter(df_world_20211230,"sub_stringency",'no','no','fac') + rremove("ylab"),
country_scatter(df_world_20211230,"sub_stringency_cubed",'no','no','fac') + rremove("ylab"), ncol = 1, common.legend = T, legend = c("right")) %>% 
  annotate_figure(map, top = text_grob(paste0("Covid deaths vs. restrictions ", "2021-12-30"), color = "black", 
          face = "bold", size = 16),left = text_grob("Total Deaths per Million", rot = 90, vjust = 1))
```
