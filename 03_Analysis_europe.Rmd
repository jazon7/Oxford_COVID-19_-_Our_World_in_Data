...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(
country_map(df_europe_20201230,'2020-12-30',"stringency","Europe",lally_countries_map,'no'),
country_map(df_europe_20201230,'2020-12-30',"total_deaths_per_million","Europe",lally_countries_map,'no'),
country_map(df_europe_20201230,'2020-12-30',"sub_stringency","Europe",lally_countries_map,'no'), 
country_map(df_europe_20201230,'2020-12-30',"sub_stringency_cubed","Europe",lally_countries_map,'no'), nrow = 2, ncol = 2) %>% 
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
country_scatter(df_europe_20201230,"stringency",'yes')
country_scatter(df_europe_20201230,"sub_stringency",'yes')
country_scatter(df_europe_20201230,"sub_stringency_cubed",'yes')
country_scatter(df_europe_20201230,"lockdowns",'yes')
country_scatter(df_europe_20201230,"lockdowns_cubed",'yes')
```
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
ggarrange(
country_map(df_europe_20211230,'2021-12-30',"stringency","Europe",lally_countries_map,'no'),
country_map(df_europe_20211230,'2021-12-30',"total_deaths_per_million","Europe",lally_countries_map,'no'),
country_map(df_europe_20211230,'2021-12-30',"sub_stringency","Europe",lally_countries_map,'no'), 
country_map(df_europe_20211230,'2021-12-30',"sub_stringency_cubed","Europe",lally_countries_map,'no'), nrow = 2, ncol = 2) %>% 
...
### Scatter plots - total covid deaths per million vs. stringency / sub_stringency cubed
```{r,echo=FALSE, message=FALSE, warning=FALSE}
country_scatter(df_europe_20211230,"stringency",'yes')
country_scatter(df_europe_20211230,"sub_stringency",'yes')
country_scatter(df_europe_20211230,"sub_stringency_cubed",'yes')
country_scatter(df_europe_20211230,"lockdowns",'yes')
country_scatter(df_europe_20211230,"lockdowns_cubed",'yes')
...
ggarrange(
country_map(df_europe_20220520,'2022-05-20',"stringency","Europe",lally_countries_map,'no'),
country_map(df_europe_20220520,'2022-05-20',"total_deaths_per_million","Europe",lally_countries_map,'no'),
country_map(df_europe_20220520,'2022-05-20',"sub_stringency","Europe",lally_countries_map,'no'), 
country_map(df_europe_20220520,'2022-05-20',"sub_stringency_cubed","Europe",lally_countries_map,'no'), nrow = 2, ncol = 2) %>% 
...
country_scatter(df_europe_20220520,"stringency",'yes')
country_scatter(df_europe_20220520,"sub_stringency",'yes')
country_scatter(df_europe_20220520,"sub_stringency_cubed",'yes')
country_scatter(df_europe_20220520,"lockdowns",'yes')
country_scatter(df_europe_20220520,"lockdowns_cubed",'yes')
```
